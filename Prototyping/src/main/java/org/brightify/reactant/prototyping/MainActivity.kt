...
class InitialController: ControllerBase<Unit, CustomRootView, AnimationAction>(CustomRootView(initialValue)) {
...
class CustomRootView(private val initialValue: Int): ViewBase<Float, AnimationAction>() {
